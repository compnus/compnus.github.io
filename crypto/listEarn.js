...
const LISTE = [
    ...
    },
    {
        ...
        banner: `<div class="promobannerad" style="background-color:#f48f27">
            <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%2Fid%2FOIP.E1g-yjbboAD6wz_myPC8cwAAAA%3Fpid%3DApi&f=1&ipt=bf97f72a9fb6c087219b63c6fe858dc8b318bc3596c0c41cd6ecf73f4d8aa2fe">
            <div>
    ...
    },
    {
        ...
        info: {
            ...
            effort: "Complete tasks and spin the wheel."
        },
        go: {
            type: 0,
            link: "https://t.me/task3_official_bot/App?startapp=sid-67e16744515cf0d9f9be7ee8"
        },
        benefits: ["If the app gets verified, we will distribute dividends."],
        features: [["Spin-a-Wheel and Tasks", "Complete various tasks, get points and use those to spin the wheel!"],
        ["Plaza", "The place for events and minigames! Most of them are only open to certain groups of people, however."]
        ],
        tips: [
...
function load() {
    for (i of LISTE) {
        ...
        else if (i.attr.coin.startsWith("other:") && !i.attr.coin.includes(" ")) coin.innerHTML = `<img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fpngimg.com%2Fuploads%2Fcoin%2Fcoin_PNG36871.png&f=1&nofb=1&ipt=e3fb6b38cdd94324ca1d7f1358e2bf66b6fbf803b701370f5ad64c7c0c1d4703"><p>${i.attr.coin.substring(6)}</p>`;
        ...
        else cnt.classList.add("fmainverm1");
